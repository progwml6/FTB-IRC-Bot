...
public class Config {
        ...
        public static void loadConfig() throws IOException, ConfigurationException{
                ...
                if (cnf.exists()) {        
                        ...
                        conf.setProperty("BOT-NICKNAME", "Progbot");
                        conf.setProperty("BOT-IDENT", "progwml6-dvs1");
                        conf.setProperty("BOT-REALNAME", "Progwml6's IRC bot");
                        ...
                        conf.setProperty("BOT-ADMINS","batman progwml6");
                        conf.setProperty("EXEC-ADMINS","batman progwml6");
